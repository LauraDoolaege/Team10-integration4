            ...
            {onboardingState === 2 && (
                <section key={onboardingState} className="onboarding onboarding-2">
                    ...
                    <div className="onboarding__text__section onboarding__text__section-2">
                        ...
                        <p className="text onboarding__text-2 transparent__black"><span className="highlight-bold">Your run kicks off the planning.</span>
Play the game and compete with your friends for a free drink!</p>
                        <button type="button" className="onboarding__button" onClick={handleContinue}>Continue</button>
                    </div>
                </section>
            )}
            ...
            {onboardingState === 3 && (
                <section key={onboardingState} className="onboarding onboarding-4">
                    ...
                    <div className="onboarding__text__section onboarding__text__section-4">
                        ...
                        <p className="text onboarding__text-4 transparent__black">Use If you’re up for it, flash those pearly whites and <span class="highlight-bold">create your character in a few seconds.</span></p>
                        <button type="button" className="onboarding__button" onClick={handleContinue}>Continue</button>
                    </div>
                </section>
            )}
