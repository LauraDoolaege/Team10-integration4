            ...
            {onboardingState === 0 && (
                <section key={onboardingState} className="trip-onboarding trip-onboarding-1">
                    ...
                    <div className="trip-onboarding__text__section trip-onboarding__text__section-1">
                        ...
                        <p className="text transparent__black"><span className="highlight-bold">You are invited</span> to a trip to Antwerp and a local bar! You can get a free drink if you <span className="highlight-bold">compete with your friends and win!</span>  </p>
            ...
            {onboardingState === 1 && (
                <section key={onboardingState} className="trip-onboarding trip-onboarding-2">
                    ...
                    <div className="trip-onboarding__text__section trip-onboarding__text__section-2">
                        ...
                        <p className="text trip-onboarding__text-2 transparent__black">You can win the voucher for a <span className="highlight-bold">free drink</span> if you get the <span className="highlight-bold">highest score.</span></p>
                        <button type="button" className="trip-onboarding__button" onClick={handleContinue}>Continue</button>
                    </div>
                </section>
            )}
            ...
            {onboardingState === 3 && (
                <section key={onboardingState} className="trip-onboarding trip-onboarding-3">
                    ...
                    <div className="trip-onboarding__text__section trip-onboarding__text__section-3">
                        ...
                        <p className="text trip-onboarding__text-3 transparent__black">Vote for the <span className="highlight-bold">hang out date</span> for your friend group to claim the <span className="highlight-bold">free drink.</span></p>
            ...
            {onboardingState === 2 && (
                <section key={onboardingState} className="trip-onboarding trip-onboarding-4">
                    ...
                    <div className="trip-onboarding__text__section trip-onboarding__text__section-4">
                        ...
                        <p className="text trip-onboarding__text-4 transparent__black">If you’re up for it, flash those pearly whites and <span className="highlight-bold">create your character</span> in a few seconds</p>
                        <button type="button" className="trip-onboarding__button" onClick={handleContinue}>Continue</button>
                    </div>
                </section>
            )}
